//MODED BY Toily changed the posiutioning of the dropdown
...
jQuery.fn.daterangepicker = function(settings){
	...
	var parentLabel = rangeInput.parent().css('position', 'relative');
	...
	function positionRP(){
		...
		rp.parent().css('left', 0).css('top', relEl.outerHeight());
	}
